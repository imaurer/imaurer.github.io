...
event: "Lay of the Land #172"
eventDate: 2024-06-27
youtubeId: OBzKK5nDVfI
episodeUrl: https://www.layoftheland.fm/172-ian-maurer-genomoncology-precision-oncology-convergence-of-genomics-ai-and-improving-c/
summary: |
  Jeffrey Stern hosts Ian Maurer, CTO of GenomOncology, on this Cleveland-focused podcast. They open with the falling cost of genome sequencing. The first human genome cost about three billion dollars and took thirteen years. A genome now costs under a thousand dollars and takes hours. GenomOncology was founded in Cleveland in 2012 to close the gap that remained: sequencing was getting cheap while the analysis still took months.

  Ian explains the company's path. The team built a research prototype on public Thousand Genomes data, used it to win engagements at Ohio State, Roswell Park, and Pitt, and asked those early partners what they struggled with. That listening produced the pathology workbench in 2013. About fifty labs now use it to validate sequencer output, classify variants, and report therapies and clinical trials. Later products exposed the curated knowledge base as an API and added tumor board software and clinical trial matching.

  The conversation turns to AI. Ian describes testing GPT-3.5 and GPT-4 against his own business and finding that a model which predicts the next token cannot serve as clinical decision support. It hallucinates, carries bias, goes stale, and does not operate at genomic scale. He argues that language models understand intent while curated knowledge bases supply facts, and he is building an oncologist assistant that connects a chatbot to the GenomOncology API through retrieval and tool use.

  Ian closes with advice. Cancer patients should find a specialist in their disease and ask for genomic testing. Young people should combine computer science with another field such as bioinformatics. Founders should expect long timelines, because startups fail only when somebody gives up.
takeaways:
  - "Genome sequencing cost fell from three billion dollars to under a thousand over two decades, and analysis became the bottleneck GenomOncology was founded to solve."
  - "GenomOncology won its first clients by building a free-data prototype, working behind firewalls at Ohio State, Roswell Park, and Pitt, and asking what those teams struggled with."
  - "The pathology workbench cuts a molecular pathology report from about six hours of manual work to about fifteen minutes, and roughly fifty labs use it."
  - "Fewer than five percent of cancer patients enroll in clinical trials, and matching software can surface candidates that manual review misses."
  - "Ian argues language models cannot replace curated clinical knowledge because they hallucinate, encode bias, go out of date, and lack genomic scale."
  - "Large language models predict the next token rather than search, so Ian pairs them with the GenomOncology knowledge base through retrieval and tool use."
  - "Ian advises cancer patients to find an expert in their specific disease and to ask for genomic testing, because it is not yet standard of care."
chapters:
  - { time: "00:00:00", label: "Cold open and introduction" }
  - { time: "00:04:14", label: "Exponential cost declines in genomics" }
  - { time: "00:07:01", label: "Founding of GenomOncology" }
  - { time: "00:08:28", label: "Chasing the hardest problems" }
  - { time: "00:14:05", label: "What precision oncology means" }
  - { time: "00:18:32", label: "Early days and first products" }
  - { time: "00:25:26", label: "Reducing the burden on doctors" }
  - { time: "00:32:08", label: "Evolution of the product line" }
  - { time: "00:37:05", label: "Measuring outcomes and efficacy" }
  - { time: "00:39:42", label: "Implications of AI" }
  - { time: "00:44:25", label: "Building an oncologist assistant" }
  - { time: "00:48:42", label: "Convergence of sequencing and AI" }
  - { time: "00:52:33", label: "Advice for cancer patients" }
  - { time: "00:54:55", label: "Lessons from company building and Cleveland" }
---

> This transcript is unedited YouTube auto-captions; expect missing punctuation and mis-heard words.
...
**[00:01:11]** people are building in Cleveland and throughout Northeast Ohio I am your host Jeffree Stern and today had the real pleasure of speaking with Ian Moore the chief technology officer at genome oncology and co-lead of the cancer informatics for Cancer Centers AI working group group with over two decades of software experience he and his LED genome oncology a
...
**[00:02:20]** oncology and Cancer Care today and how the field has progressed over time the founding and evolution of genome oncology to amarate this entire space solving hard problems Building in Cleveland the everchanging frontiers of AI and genomics exponential technology and a whole lot more so please enjoy this awesome conversation with Ian Moore after a brief message from our
...
**[00:08:28]** mutual friend akos who used to work with you at at genome oncology and I had asked him you know what question or topic should I be sure to to ask you about and uh he he brought up your philosophy around explicitly opting to Chase and follow the hardest problems and to me that felt like a great place to kick off you know understanding a bit more about what motivates you and how
...
**[00:14:05]** therapy and and bioinformatics and just the the space that that genome oncology is operating within you know may maybe around the time even just before it was founding and some of the history that you know created the opportunity for for this whole undertaking in the first place sure so obviously cancer has a long history I'm not going to go into that what we do for cancer patients at
...
**[00:32:08]** want to unpack the artificial intelligence side of this with you and and maybe where a lot of this is headed but take us through kind of the the evolution of of genome oncology as a as a company throughout throughout this kind of product offering so we started in 2013 with mythology workbench and we grabbed some early adopters right and we saw real quick uptake signed a lot of
